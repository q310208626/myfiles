...
* 项目名称：myfiles   
* 类名称：MFMController   
* 类描述：MyFilesManager 的控制层   
* 创建人：shaojia   
* 创建时间：Sep 3, 2017 1:27:12 PM   
* 修改人：shaojia   
* 修改时间：Sep 3, 2017 1:27:12 PM   
* 修改备注：   
* @version    
*    
*/
...
public class MFMController {
	...
	public ModelAndView MFMLogin(MyFilesManager myFilesManager){
		...
		logger.debug("----------------myFilesManager"+myFilesManager.getAccount());
		logger.debug("----------------myFilesManager"+myFilesManager.getPassword());
